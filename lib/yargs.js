var argv = require('yargs')
  ...
  .option('r', {
    alias: 'redisUrl',
    description: 'URL for connect with your redis instance, in the format "redis://127.0.0.1:6379". We use Redis to manage sessions. Without Redis, session data is stored in memory and doesn\'t have the capacity to manage sessions for a production site.'
  })
  .option('n', {
    alias: 'custom404',
  ...
  .option('j', {
    alias: 'serverSslCert',
    description: 'Certificate to use if you want https. To enable https provide SSL certificate and key. You can inform a path or a string with the content of certificate.'
  })
  .option('k', {
    alias: 'serverSslKey',
    description: 'Key to use if you want https. To enable https provide SSL certificate and key. You can inform a path or a string with the content of key.'
  })
