var argv = require('yargs')
  ...
  .option('r', {
    alias: 'redisUrl',
    description: 'URL for connect with your Redis instance in the format "redis://127.0.0.1:6379". We use Redis to manage sessions. Without Redis, session data is stored in memory and errors are very commons.'
  })
  .option('o', {
  ...
  .option('j', {
    alias: 'serverSslCert',
    description: 'Cert to use if you want https. To enable https provide SSL certificate and key. You can inform a path or a string with content of certificate.'
  })
  .option('k', {
    alias: 'serverSslKey',
  ...
  .epilog('You can use enviroment variables too. For more info go to https://github.com/andreleite/okta-for-static-site/')
  .argv;
